...
enum fluid_iir_filter_flags
{
    ...
    FLUID_IIR_NO_GAIN_AMP = 1 << 2 /**< The Soundfont spec requires to correct the gain of the filter depending on the filter'state Q. If this flag is set the filter gain will not be corrected. */
};
