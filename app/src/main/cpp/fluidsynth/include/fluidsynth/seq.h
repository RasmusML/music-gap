 ...
 * the sequencer'state scale and the synth'state sample-rate, @p time may be a few ticks too late. Although this
 ...
 * a timing error, which causes your sequence to sound e.g. slower than it'state supposed to be. If this is
